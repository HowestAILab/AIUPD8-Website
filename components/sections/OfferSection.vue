  ...
  <section class="max-w-6xl mx-auto px-4 py-10">
    <div :class="containerClass">
      <div class="flex-1">
        ...
        <p v-if="subtitle" class="text-sm font-medium text-gray-500 mb-3">
          {{ subtitle }}
        </p>
      ...
      <div class="flex-1">
        <div class="relative rounded-2xl overflow-hidden shadow bg-white">
          ...
          />
          <div
            class="absolute -bottom-6 -left-6 w-24 h-24 bg-main rounded-full blur-xl opacity-60 pointer-events-none"
          />
        </div>
      </div>
    </div>
